<?PHP
unset($PHPSESSID); unset($_COOKIE['PHPSESSID']);
$RegistrarVar = array();
foreach( $_GET as $k => $v ){
...
unset($rFile);unset($rOk);unset($rDim);unset($rTmp);unset($rVer);unset($n);unset($c);unset($Cond);unset($PHPSESSID); unset($_COOKIE['PHPSESSID']);
session_start();
$_Estadistica = true;
