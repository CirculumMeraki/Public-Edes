...
var tabla = S("<table id='_SELECTCOLOR' class='TOOLBAR'><tr><th class='TITULO'>Selecciona color</th><th class='TITULO' width=1px><i class='ICONWINDOW' op='C' onclick=S(S.toTag(S.event(window),'TABLE')).none()>5</i></th></tr><tr><td colspan=2><canvas></td></tr></table>").obj,
